...
namespace FlappyBird
{
    public partial class Form1 : Form
    {
        ...
        public Form1(int secim)
        {
            InitializeComponent();
            gelenSecim = secim;
            if (gelenSecim == 0)//Kolay
            {
                tmrGame.Interval = 100;
            }
            else if (gelenSecim == 1)//Orta
            {
                tmrGame.Interval = 50;
            }
            else if (gelenSecim == 2)//Zor
            {
                tmrGame.Interval = 20;
            }
        }
        ...
        private void tmrGame_Tick(object sender, EventArgs e)
        {
            ...
            if (pbPipe1.Right <= 0)
            {
                ...
                pbPipe1.Height = rnd.Next(95, 150);//boy random gelmesi için.
            ...
            if (pbPipe4.Right <= 0)
            {
                ...
                pbPipe4.Height = rnd.Next(95, 150);
            }
